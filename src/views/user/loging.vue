  ...
  <div>
    <div class="content">
      ...
      <el-form v-if="login_method === 'is_pwd'">
        ...
        <el-button type="info" @click="login_password">登录</el-button>
      </el-form>
      <el-form v-if="login_method === 'is_sms'">
        ...
        <el-button type="info" @click="code_login">登录</el-button>
      </el-form>
      <!-- <div class="foot">
...
export default {
  ...
  methods: {
    ...
    check_mobile() {
      ...
      this.$axios
        .get(this.$settings.base_url + "/user/check_telephone/", {
          params: { telephone: this.mobile },
        })
        .then((response) => {
    ...
    send_sms() {
      ...
      this.$axios
        .get(this.$settings.base_url + "/user/send/", {
          params: { telephone: this.mobile },
        })
        .then((response) => {
          if (response.data.code) {
    ...
    login_password() {
      if (this.username && this.password) {
        ...
        //发送请求
        this.$axios
          .post(this.$settings.base_url + "/user/login/", {
    ...
    code_login() {
      if (this.mobile && this.sms) {
        //发送请求
        this.$axios
          .post(this.$settings.base_url + "/user/code_login/", {
